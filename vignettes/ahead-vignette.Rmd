...
- `dynrmf`: **univariate** time series forecasting method adapted from [`forecast::nnetar`](https://otexts.com/fpp/nnetar.html#neural-network-autoregression) to support any 
...
# Plotting forecasts 
# fpp2::insurance contains 2 time series, Quotes and TV.advert 
