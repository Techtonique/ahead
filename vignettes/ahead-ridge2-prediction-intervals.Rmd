...
(res1 <- ahead::ridge2f(fpp2::insurance, h = h))
...
(res2 <- ahead::ridge2f(fpp2::insurance, xreg = xreg, h = h))
...
centers <- 2L
(res3 <- ahead::ridge2f(fpp2::insurance, xreg = xreg, centers = centers, h = h))
...
centers <- 2L
(res10 <- ahead::ridge2f(fpp2::insurance, centers = centers, h = h))
...
(res4 <- ahead::ridge2f(fpp2::insurance, 
...
```{r "bootstrap-xreg-clustering", fig.width=7.2, eval=FALSE}
...
centers <- 2L
(res11 <- ahead::ridge2f(fpp2::insurance, 
                         centers = centers, 
                         type_pi = "bootstrap", B = B, h = h))
...
block_length <- 5L
(res7 <- ahead::ridge2f(fpp2::insurance, 
...
(res8 <- ahead::ridge2f(fpp2::insurance, xreg = xreg, 
                        type_pi = "blockbootstrap", 
                        block_length = block_length,
                        B = B, h = h))
...
(res9 <- ahead::ridge2f(fpp2::insurance, 
...
(res12 <- ahead::ridge2f(fpp2::insurance, 
                         centers = centers, 
                         type_pi = "blockbootstrap", 
                         block_length = block_length,
                         B = B, h = h))
...
(res13 <- ahead::ridge2f(fpp2::insurance, 
                         centers = centers, 
                         type_pi = "blockbootstrap", 
...
block_length <- 5L
(res16 <- ahead::ridge2f(fpp2::insurance, 
...
(res15 <- ahead::ridge2f(fpp2::insurance, 
                        xreg = xreg, centers = centers, 
                        type_pi = "movingblockbootstrap", 
                        block_length = block_length,
                        B = B, h = h))
...
(res14 <- ahead::ridge2f(fpp2::insurance, 
                         centers = centers, 
                         type_pi = "movingblockbootstrap", 
                         type_aggregation = "median",
                         block_length = block_length,
...
```{r, "RVineCopula", fig.width=7.2, eval=FALSE}
(obj <- ahead::ridge2f(fpp2::insurance, 
                         type_pi = "rvinecopula", 
                         B = B, h = h))
