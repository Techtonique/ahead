...
vignette: >
  %\VignetteIndexEntry{Prediction intervals (simulation-based) in R package `ahead`}
...
The model used is in this demo is the one presented in [this paper](https://www.mdpi.com/2227-9091/6/1/22), and has actually been significantly improved since 2018, as you'll see here. 

Currently for this model (as of 2023-08-12), for **uncertainty quantification**, options are a Gaussian distribution for the residuals or bootstrap aggregation:

-   Gaussian
-   Independent **bootstrap** 
-   Multivariate circular **block bootstrap** 
